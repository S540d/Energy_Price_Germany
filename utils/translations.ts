...
export const translations = {
  en: {
    ...
    now: 'Now',
    average: 'Avg',
    averageLowCoverage: 'No average: only {valid} of {total} values',
    renewableFallbackOwn: '⚠ Local value, PLZ {location}',
    renewableFallbackDefault: '⚠ {location} only, not nationwide',
    renewableFallbackChartLabel: 'Local value ({location})',
    night: 'Night',
    morningEvening: 'M/E',
    day: 'Day',
    ...
    metricAvg: 'Average',
    metricMax: 'Maximum',
    // Historical Data View (#1, #3)
    historyViewTitle: 'Historical Data',
    historyOpen: 'History',
    historyRange24h: '24h',
    historyRange48h: '48h',
    ...
    historyEmpty: 'No historical data for this period yet. It will accumulate as you use the app.',
    historyPriceSection: 'Price (¢/kWh)',
    historyRenewableSection: 'Renewables (%)',
  },
  de: {
    ...
    renewableFallbackOwn: '⚠ Ortswert, PLZ {location}',
    renewableFallbackDefault: '⚠ nur {location}, nicht bundesweit',
    renewableFallbackChartLabel: 'Ortswert ({location})',
    night: 'Nacht',
    morningEvening: 'M/A',
    day: 'Tag',
    ...
    metricMax: 'Maximum',
    // Historical Data View (#1, #3)
    historyViewTitle: 'Historische Daten',
    historyOpen: 'Verlauf',
    historyRange24h: '24h',
    historyRange48h: '48h',
    historyRange7d: '7 Tage',
    historyRange30d: '30 Tage',
    ...
    historyEmpty:
      'Noch keine historischen Daten für diesen Zeitraum. Sie werden mit der Nutzung der App gesammelt.',
    historyPriceSection: 'Preis (¢/kWh)',
    historyRenewableSection: 'Erneuerbare (%)',
  },
} as const;
